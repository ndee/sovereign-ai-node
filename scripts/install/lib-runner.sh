...
# lib-runner: install-runner pipeline — install_command, runtime-readiness
# probes, JSON parsers and human-readable summarisers, post-install
# diagnostics, host-resource Ansible step.
#
# Depends on lib-log, lib-ui, lib-matrix-urls (for the post-install Matrix
# guidance printer). Reads RUN_INSTALL, ACTION, INSTALL_COMMAND_OUTPUT,
# RUNTIME_STATUS_OUTPUT, DOCTOR_REPORT_OUTPUT.
