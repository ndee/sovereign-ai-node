...
NODE_ARTIFACT="${SOVEREIGN_NODE_ARTIFACT:-}"
NODE_ARTIFACT_MANIFEST="${SOVEREIGN_NODE_ARTIFACT_MANIFEST:-}"
...
# shellcheck source=install/lib-node-artifact.sh
source "${INSTALL_LIB_DIR}/lib-node-artifact.sh"
